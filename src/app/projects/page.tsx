    ...
    <div className={`flex flex-col items-center w-full min-h-screen pb-5`}>
      <div className={`w-5/6 sm:w-2/3 md:w-7/12 xl:w-1/2`}>
        <div className="grid grid-cols-1 md:grid-cols-2 mt-16 sm:mt-20 md:mt-24 lg:mt-28 gap-5 ">
          <AnimationShellOfX duration={1} delay={0} x="-100%">
            <EachProject
              title="Todo"
          ...
          <AnimationShellOfX duration={1.5} delay={0} x="100%">
            <EachProject
              title="Emporium"
          ...
          <AnimationShellOfX duration={1.5} delay={0.5} x="100%">
            <EachProject
          ...
          <AnimationShellOfX duration={1} delay={1} x="-100%">
            <EachProject
              title="Portfolio"
          ...
          <AnimationShellOfX duration={1.5} delay={1} x="100%">
            <EachProject
